...
export default function RegisterPage() {
  ...
  return (
    <main className="mx-auto max-w-sm p-24 text-pink-800">
      <h1 className="text-2xl font-bold">Create an Account</h1>

      <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-4 text-pink-600">
        <div>
        ...
        <div>
          ...
          <input
            ...
            className="mt-1 w-full rounded-md border px-3 py-2"
          />
          <p className="mt-1 text-xs text-pink-500">At least 8 characters.</p>
        </div>
